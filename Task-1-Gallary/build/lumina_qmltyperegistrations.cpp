...
#if __has_include(<GalleryModel.h>)
#  include <GalleryModel.h>
#endif
#if __has_include(<TempReader.h>)
...
Q_QMLTYPE_EXPORT void qml_register_types_Main()
{
    ...
    qmlRegisterTypesAndRevisions<GalleryModel>("Main", 1);
    ...
    qmlRegisterTypesAndRevisions<TempReader>("Main", 1);
    QT_WARNING_POP
